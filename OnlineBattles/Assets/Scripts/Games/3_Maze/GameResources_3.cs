...
namespace Game3
{
    public class GameResources_3 : GeneralController
    {
        ...
        //TODO: ƒобавит звук или какую-то анимацию после Collect point.
        //TODO: ƒобавить проверку времени на нажатие кнопки клиентом. „тоб не взломали и не нажимали слишком часто на смену лабиринта
