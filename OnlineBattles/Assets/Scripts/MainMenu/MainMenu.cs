...
public class MainMenu : MonoBehaviour
{
    ...
    //TODO: Нафиг статик GameRes, лучше сслыками сделать, тогда с очерёдностью awake всё будет нормально, и указать не забудешь

    //TODO: Надо оставить на кавасе только UI, осатльное вынести в общее пространство

    //TODO: Есть баг, если оба нажмут паузу. Пауза не будет дожидпться второго, надо где-то добавить проверку

    //TODO: Похоже в классах шаблонах не выполняется OnDestroy тк он является родительским

    //TODO: Вернуть везде ConnectionLifeSupport
